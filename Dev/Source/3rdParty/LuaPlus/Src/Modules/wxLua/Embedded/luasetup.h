// Automatically generated by wxLuaWrap.lua from ../Embedded/luasetup.h.in
...
#define wxLUA_USE_wxStyledTextCtrl              0
...
#define wxLUA_USE_wxXMLResource                 0
